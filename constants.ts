...
create table public.pm_members (
  id bigint generated by default as identity primary key,
  user_id uuid references auth.users, -- 可选：关联 auth.users
  email text not null,
  name text,
...
-- 仅供参考：插入管理员
-- insert into public.pm_members (email, name, role) values ('admin@example.com', 'Admin', 'admin');
`;
...
export const MOCK_MEMBERS: any[] = [
  { id: 1, email: 'demo@example.com', name: '演示用户', role: 'member', status: 'active', joinedAt: '2024-01-01' },
];
